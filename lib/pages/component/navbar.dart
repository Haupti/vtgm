...
Component navBar() {
  ...
  var roles = Component.fromHtmlString(
      """<a href="/person/roles" class="btn btn-link">Roles</a>""");
    ...
    <section class="navbar-section">
      <div class="dropdown">
        ...
        <ul class="menu">
            ...
            <li class="menu-item"><a href="/person/roles">Roles</a></li>
            ${currentRole == AuthRole.mod || currentRole == AuthRole.admin ? """<li class="menu-item"><a href="/person/update">Manager</a></li>""" : ""}
            ${currentRole == AuthRole.admin ? """<li class="menu-item"><a href="/person/roles/set">Set Roles</a></li>""" : ""}
